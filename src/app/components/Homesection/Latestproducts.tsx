...
function LatestProducts() {
  const products = [
    { id: 1, img: "/homeimages/latest one.png" },
    { id: 2, img: "/homeimages/latest two.png", sale: true },
    { id: 3, img: "/homeimages/latest three.png" },
    { id: 4, img: "/homeimages/latest four.png" },
    { id: 5, img: "/homeimages/latest five.png" },
    { id: 6, img: "/homeimages/latest six.png" },
  ];
            ...
            <div className="w-full bg-gray-200 flex justify-center items-center relative overflow-hidden h-[200px] sm:h-[250px] md:h-[300px] transition-transform duration-300 hover:scale-105 hover:shadow-2xl hover:bg-[#F3F3F3]">
              ...
              {product.sale && (
                <span className="absolute top-2 left-2 bg-[#3F509E] text-white text-xs sm:text-sm px-1 py-0 rounded">
                  <Image src="/homeimages/Group 27.png" alt="Sale" width={80} height={80} />
                </span>
              )}
              <Image
                src={product.img}
