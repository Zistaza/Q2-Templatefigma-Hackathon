...
function TrendingProducts() {
  const products = [
    { id: 1, img: "/homeimages/trending1.png" },
    { id: 2, img: "/homeimages/trending2.png" },
    { id: 3, img: "/homeimages/trending3.png" },
    { id: 4, img: "/homeimages/trending4.png" },
  ];

  const exclusiveProducts = [
    { id: 1, img: "/homeimages/Trendingfourside.png" },
    { id: 2, img: "/homeimages/Trendingfiveside.png" },
    { id: 3, img: "/homeimages/Trendindsixside.png" },
  ];
