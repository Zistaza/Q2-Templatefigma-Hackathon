...
<section className="bg-[#F6F5FF] h-[200px] md:h-[286px]">
    ...
    <div className="flex flex-col gap-2">
      <div className="bg-[#F6F7FB] h-[100px] w-[100px] lg:h-[155px] lg:w-[150px] rounded-md flex justify-center items-center">
        <Image
          ...
          src="/pagesimages/pageProductone.png"
          alt="purse"
        />
      </div>
      <div className="bg-[#F6F7FB] h-[100px] w-[100px] lg:h-[155px] lg:w-[150px] rounded-md flex justify-center items-center">
        <Image
          ...
          width={155}
          className="rounded-md object-cover"
          src="/pagesimages/pageProduct2.png"
          alt="light"
        />
      </div>
      <div className="bg-[#F6F7FB] h-[100px] w-[100px] lg:h-[155px] lg:w-[150px] rounded-md flex justify-center items-center">
        <Image
          ...
          width={155}
          className="rounded-md object-cover"
          src="/pagesimages/pageProductthree.png"
          alt="nail"
        />
      </div>
    </div>
  ...
  <Image
    ...
    height={500}
    width={500}
    src="/pagesimages/pageProductmain.png"
        ...
        />
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <Image
                src={"/pagesimages/facebookicon.png"}
                width={15}
                height={15}
                alt="Facebook"
              ...
              />
              <Image
                src={"/pagesimages/intagramicon.png"}
                width={15}
                height={15}
                alt="Instagram"
              ...
              />
              <Image
                src={"/pagesimages/twittericon.png"}
                width={15}
                height={15}
                alt="Twitter"
                className="bg-blue-900"
