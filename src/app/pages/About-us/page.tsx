...
<section className="bg-[#F6F5FF] h-auto md:h-[286px] py-8">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
    {[
      { icon: "/homeimages/shopex one.png", title: "Free Delivery" },
      { icon: "/homeimages/shopex two.png", title: "100% Cash Back" },
      { icon: "/homeimages/shopex three.png", title: "Quality Product" },
      { icon: "/homeimages/shopex four.png", title: "24/7 Support" },
    ].map((feature, index) => (
      <div
        key={index}
  ...
  <div className="flex items-center justify-center pb-2">
    ...
    <div className="flex justify-center min-w-screen">
    <Image
        src="/pagesimages/salina gomez.png"
        alt="gomez"
        width={100}
        height={100}
        className="rounded-md shadow-md"
