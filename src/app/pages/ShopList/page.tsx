...
const shoplist = [
  {
    ...
    image: "/pagesimages/shoplist1.png",
    price: "$26.00",
    oldPrice: "$52.00",
  ...
  },
  {
    id: 2,
    name: "In nulla",
    image: "/pagesimages/shoplist2.png",
    price: "$26.00",
    oldPrice: "$52.00",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.",
    rating: 4,
  ...
  },
  {
    id: 3,
    name: "Vel sem",
    image: "/pagesimages/shoplist3.png",
    price: "$26.00",
    oldPrice: "$52.00",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.",
    rating: 5,
    ...
    id: 4,
    name: "Porttitor cum",
    image: "/pagesimages/shoplist4.png",
    price: "$26.00",
    oldPrice: "$52.00",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.",
    rating: 4,
    ...
    id: 5,
    name: "Nunc in",
    image: "/pagesimages/shoplist5.png",
    price: "$26.00",
    oldPrice: "$52.00",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.",
    rating: 4,
    ...
    image: "/pagesimages/shopist6.png",
    price: "$26.00",
    oldPrice: "$52.00",
    ...
    image: "/pagesimages/shoplist7.png",
    price: "$26.00",
    oldPrice: "$52.00",
    description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.",
    rating: 4,
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <Image
            ...
            src="/pagesimages/shoplistvector2.png"
            alt="Grid view"
            width={20}
            height={20}
          />
          <Image
            className="ml-2 h-5 w-5"
            src="/pagesimages/vector shoplist.png"
            alt="List view"
            width={20}
            height={20}
          />
